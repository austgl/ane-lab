...
import market.android.anelab.util.Base64;
import market.android.anelab.util.Base64DecoderException;
...
public class Security {
    ...
    public static ArrayList<VerifiedPurchase> verifyPurchase(
    		String base64EncodedPublicKey, String signedData, String signature) {
        if (signedData == null) {
