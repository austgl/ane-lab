...
public class Consts {
    ...
    // MODIFICATION : Intent has been changed to "market.android.anelab @tokufxug"
    public static final String ACTION_CONFIRM_NOTIFICATION =
        "market.android.anelab.CONFIRM_NOTIFICATION";
    public static final String ACTION_GET_PURCHASE_INFORMATION =
        "market.android.anelab.GET_PURCHASE_INFORMATION";
    public static final String ACTION_RESTORE_TRANSACTIONS =
        "market.android.anelab.RESTORE_TRANSACTIONS";
