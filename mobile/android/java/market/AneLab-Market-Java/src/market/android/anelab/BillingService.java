...
import market.android.anelab.Security.VerifiedPurchase;
...
public class BillingService extends Service implements ServiceConnection {
    ...
    // MODIFICATION : add setting Base64 encode RSA public key @tokufxug"
    /**
     * setting Base64 encode RSA public key
     */
    private static String mEncodedPublicKey = null;

    // MODIFICATION : remove onStart Method @tokufxug

    // MODIFICATION : add synchronized @tokufxug"
    /**
    ...
    // MODIFICATION : add param Base64 encode RSA public key @tokufxug"
    public BillingService(String encodedPublicKey) {
        super();
        // MODIFICATION : setting Base64 encode RSA public key @tokufxug"
     ...
     */
    private synchronized boolean confirmNotifications(int startId, String[] notifyIds) {
     ...
     * @return false if there was an error connecting to Android Market
     */
    private synchronized boolean getPurchaseInformation(int startId, String[] notifyIds) {
     ...
     */
    private synchronized void purchaseStateChanged(int startId, String signedData, String signature) {
        ArrayList<Security.VerifiedPurchase> purchases;
        purchases = Security.verifyPurchase(
        		mEncodedPublicKey, signedData, signature);
     ...
     * of the request
     */
    private synchronized void checkResponseCode(long requestId, ResponseCode responseCode) {
