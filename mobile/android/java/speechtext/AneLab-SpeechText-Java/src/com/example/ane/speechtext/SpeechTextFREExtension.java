		...
		FREFunction func = new FREFunction() {
			...
			public FREObject call(FREContext arg0, FREObject[] arg1) {
				try {
					...
					Intent speechIntent = new Intent(a,
							SpeechTextActivity.class);
			...
			public FREObject call(FREContext arg0, FREObject[] arg1) {
				try {
					...
					NotificationManager nf =
							(NotificationManager) arg0.getActivity().getSystemService(
									Activity.NOTIFICATION_SERVICE);

					Notification n = new Notification(
							arg0.getResourceId("drawable.icon"), "正常に終了しました",
							System.currentTimeMillis());

					Intent intent = new Intent(Intent.ACTION_VIEW);
					PendingIntent pi = PendingIntent.getActivity(
							arg0.getActivity(), 0, intent, 0);

					n.setLatestEventInfo(arg0.getActivity(), "SpeechText",
							"最後のつぶやき【"+ arg1[0].getAsString() +"】でした", pi);
