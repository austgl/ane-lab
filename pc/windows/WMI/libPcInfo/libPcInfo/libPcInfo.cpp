...
FREObject getPcInfo(FREContext ctx, void* funcData, uint32_t argc, FREObject argv[])
{
	...
	ComputerBean^ bean = hoge.info->getPcInfo();

	FRENewObject((const uint8_t*)"com.chocbanana.win.Pc", 0, NULL, &result, NULL);

	String^ __cpuClock = (String^)bean->cpuClock;
	...
	String^ __cpuInfo = (String^)bean->cpuInfo;
	...
	String^ __memoryTotal = (String^)bean->memoryTotal;
	...
	String^ __computerName = (String^)bean->computerName;
	...
	String^ __computerDomain = (String^)bean->computerDomain;
	...
	String^ __computerRole = (String^)bean->computerRole;
	...
	String^ __computerModel = (String^)bean->computerModel;
	...
	String^ __osName = (String^)bean->osName;
	...
	String^ __osVersion = (String^)bean->osVersion;
	...
	String^ __C_Total = (String^)bean->C_Total;
	...
	String^ __C_Used = (String^)bean->C_Used;
	...
	String^ __C_Free = (String^)bean->C_Free;
	...
	String^ __C_FreePercent = (String^)bean->C_FreePercent;
	...
	String^ __logonAccount = (String^)bean->logonAccount;
	...
	String^ __logonTime = (String^)bean->logonTime;
